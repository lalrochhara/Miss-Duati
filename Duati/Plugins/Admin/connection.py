...
import Duati.Database.connection_sql as sql
from Duati import dispatcher, INSPECTOR, DEV_USERS
from Duati.Handlers import validation
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want everDuati to see; This is where connections come in...
