...
from Duati.__help__ import STATS, USER_INFO
import Duati.Database.userinfo_sql as sql
from Duati.Plugins.disable import DisableAbleCommandHandler
from Duati.Database.global_bans_sql import is_user_gbanned
from Duati.Database.afk_sql import is_afk, check_afk_status
from Duati.Database.users_sql import get_user_num_chats
from Duati.Handlers.validation import sudo_plus, user_admin, support_plus
from Duati.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'Duati Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Duati_Updates">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Duati_Updates)
"""
__mod_name__ = "Infos"
