...
from Duati.Handlers.msg_types import Types
from Duati.Database import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. EverDuati, look busy!",
    ...
    "EverDuati stop what you’re doing, We are now in the presence of {first}.",
